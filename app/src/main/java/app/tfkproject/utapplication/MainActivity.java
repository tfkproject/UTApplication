...
//        });
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.form_ppm));
        setFragment(FormPPM.class);
    }
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.form_ppm) {
            getSupportActionBar().setTitle(getResources().getString(R.string.form_ppm));
            setFragment(FormPPM.class);
//        } else if (id == R.id.form_p2u) {
//            getSupportActionBar().setTitle(getResources().getString(R.string.form_p2u));
//            setFragment(FormPPM.class);
//            Toast.makeText(this, "Sedang dikerjakan", Toast.LENGTH_SHORT).show();
