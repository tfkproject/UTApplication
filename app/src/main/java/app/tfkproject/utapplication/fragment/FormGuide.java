...
import app.tfkproject.utapplication.GuideHd465_7R;
import app.tfkproject.utapplication.GuideHd785_7;
import app.tfkproject.utapplication.R;

public class FormGuide extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.form_guide, container, false);
        ...
        btnHd465_7r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), GuideHd465_7R.class);
        ...
        btnHd785_7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), GuideHd785_7.class);
                getContext().startActivity(intent);
            }
        });
        ...
        btnPc1250_8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "Menunggu data", Toast.LENGTH_SHORT).show();
            }
        });
